...
//        XCTAssert(window.frame.contains(buta.frame))
        ...
        // redy状態で起動するとチュートリアルが表示されていること
        // playing状態で起動すると何も表示されていないこと
        // finished状態で起動するとリザルトが表示されていること
        // スコアが0になるとそれ以上ポイントが減らないこと
        // スコアが0になるとブタの動きが遅くなること
        // スコアが0になるとブタをさわれなくなること
        // スコアが0になると「そこまで」が表示され、その後リザルトが表示されること
        // リザルトから「次」を選ぶとポイントが新しくなること
        // リザルトから「次」を選ぶとチュートリアルが表示されること
        // リザルトから「次」を選ぶとブタがさわれるようになること
        //　再起動してもその前のステージ情報が保たれていること
    }
